...
var HistoryStateManager = class _HistoryStateManager extends StateManager {
  ...
  setBrowserUrl(url, transition) {
    ...
    if (this.location.isCurrentPathEqualTo(path2) || !!transition.extras.replaceUrl) {
...
function afterNextNavigation(router, action) {
  ...
  }), (0, import_operators.filter)((result2) => result2 !== NavigationResult.REDIRECTING), (0, import_operators.take)(1)).subscribe(() => {
    action();
  });
}
...
var RouterLinkActive = class _RouterLinkActive {
  ...
  subscribeToEachLinkOnChanges() {
    ...
    this.linkInputChangesSubscription = (0, import_rxjs.from)(allLinkChanges).pipe((0, import_operators.mergeAll)()).subscribe((link2) => {
...
function requireInput() {
  ...
  class Input2 {
    ...
    origin(line, column, endLine, endColumn) {
      ...
      let from2 = consumer.originalPositionFor({
        column,
        line
      });
              ...
              if (typeof plugin[event] === "object") {
                for (let filter3 in plugin[event]) {
                  if (filter3 === "*") {
                    ...
                    add(plugin, event + "-" + filter3.toLowerCase(), plugin[event][filter3]);
                  }
                }
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-KV3DDCL5.js.map
